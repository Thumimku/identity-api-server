...
public class RemoteFetchConfigurationGetResponse  {
    ...
    **/
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, isEnabled, remoteFetchName, repositoryManagerType, actionListenerType, configurationDeployerType, repositoryManagerAttributes, actionListenerAttributes, configurationDeployerAttributes);
    }
