...
public class RemoteFetchApiServiceImpl implements RemoteFetchApiService {
    ...
    @Override
    public Response addRemoteFetchConfig(RemoteFetchConfigurationPOSTRequest remoteFetchConfigurationPOSTRequest) {

        String remoteFetchConfigurationId = serverRemoteFetchConfigManagementService.addRemoteFetchConfiguration
    ...
    @Override
    public Response deleteRemoteFetchConfig(String id) {
    ...
    public Response getAllComponentUIFields() {
        ...
        AllComponentUIFieldsResponse allComponentUIFieldsResponse =
                serverRemoteFetchConfigManagementService.getAllComponentUIFields();
        return Response.ok().entity(allComponentUIFieldsResponse).build();
    }

    @Override
    public Response getRemoteFetchConfigs(Integer limit, Integer offset) {

        RemoteFetchConfigurationListResponse remoteFetchConfigurationListResponse =
                serverRemoteFetchConfigManagementService.getRemoteFetchConfigs(limit, offset);
        return Response.ok().entity(remoteFetchConfigurationListResponse).build();
    }

    @Override
    public Response getRemoteFetchConfig(String id) {
    ...
    public Response triggerRemoteFetch(String id) {
        ...
        String remoteFetchConfigurationId = serverRemoteFetchConfigManagementService
                .triggerRemoteFetch(id);
        return Response.created(getResourceLocation(remoteFetchConfigurationId)).build();
    }

    @Override
    public Response updateRemoteFetchConfig(String id,
