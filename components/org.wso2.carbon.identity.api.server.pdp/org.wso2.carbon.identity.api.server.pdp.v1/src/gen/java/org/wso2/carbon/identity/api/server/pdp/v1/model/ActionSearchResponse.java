...
public class ActionSearchResponse  {
    ...
    **/
    public ActionSearchResponse results(List<Action> results) {
    ...
    public ActionSearchResponse addResultsItem(Action resultsItem) {
    ...
    **/
    public ActionSearchResponse page(Map<String, Object> page) {
    ...
    public ActionSearchResponse putPageItem(String key, Object pageItem) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ActionSearchResponse actionSearchResponse = (ActionSearchResponse) o;
        return Objects.equals(this.results, actionSearchResponse.results) &&
            Objects.equals(this.page, actionSearchResponse.page);
    }
    ...
    public String toString() {
        ...
        sb.append("class ActionSearchResponse {\n");
