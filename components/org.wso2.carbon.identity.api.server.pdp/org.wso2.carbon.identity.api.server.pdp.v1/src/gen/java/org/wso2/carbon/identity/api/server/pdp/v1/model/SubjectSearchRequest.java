...
public class SubjectSearchRequest  {
    ...
    /**
    **/
    public SubjectSearchRequest subject(Subject subject) {
    ...
    /**
    **/
    public SubjectSearchRequest resource(Resource resource) {
    ...
    /**
    **/
    public SubjectSearchRequest action(Action action) {
    ...
    **/
    public SubjectSearchRequest context(Map<String, Object> context) {
    ...
    public SubjectSearchRequest putContextItem(String key, Object contextItem) {
    ...
    **/
    public SubjectSearchRequest page(Map<String, Object> page) {
    ...
    public SubjectSearchRequest putPageItem(String key, Object pageItem) {
        if (this.page == null) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SubjectSearchRequest subjectSearchRequest = (SubjectSearchRequest) o;
        return Objects.equals(this.subject, subjectSearchRequest.subject) &&
            Objects.equals(this.resource, subjectSearchRequest.resource) &&
            Objects.equals(this.action, subjectSearchRequest.action) &&
            Objects.equals(this.context, subjectSearchRequest.context) &&
            Objects.equals(this.page, subjectSearchRequest.page);
    }
    ...
    public String toString() {
        ...
        sb.append("class SubjectSearchRequest {\n");
