...
public class SubjectSearchResponse  {
    ...
    **/
    public SubjectSearchResponse results(List<Subject> results) {
    ...
    public SubjectSearchResponse addResultsItem(Subject resultsItem) {
    ...
    **/
    public SubjectSearchResponse page(Map<String, Object> page) {
    ...
    public SubjectSearchResponse putPageItem(String key, Object pageItem) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SubjectSearchResponse subjectSearchResponse = (SubjectSearchResponse) o;
        return Objects.equals(this.results, subjectSearchResponse.results) &&
            Objects.equals(this.page, subjectSearchResponse.page);
    }
    ...
    public String toString() {
        ...
        sb.append("class SubjectSearchResponse {\n");
